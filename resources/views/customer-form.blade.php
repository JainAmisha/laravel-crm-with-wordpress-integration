        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="container my-5">
                    <h3 class="display-4 text-center" style="font-size: 40px;">Customer Details</h3>
                    <hr>
                    <form action="{{ route('customer.store') }}" method="post" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('desired_budget') is-invalid @enderror" name="desired_budget" id="desired_budget" min="0" value="{{ old('desired_budget') }}" required/>
